 ...
 * Not reusing PublicShareCard here: its "compact" variant renders a
 * full card (heading, public/private badge, URL preview) — much
 * heavier than this page's plain pill button, so this owns a small,
 * self-contained share/copy instead.
 */
